...
![Formateo a CSV con Evtxcmd.exe](/05-ctf-writeup/HTB-Unit-42/Images/pre-lab-01.png)

![Uso de tool CSV quick viewer](/05-ctf-writeup/HTB-Unit-42/Images/pre-lab-02.png)

This answer is simple. All I did to obtain this information was filter it by event ID.

![Filtrar por ID](/05-ctf-writeup/HTB-Unit-42/Images/filtrar-por-eventid11.png) 
...
![Filtre ID](/05-ctf-writeup/HTB-Unit-42/Images/process-path-malicious.png) 
...
![Filtre to detect Cloud drive](/05-ctf-writeup/HTB-Unit-42/Images/eventid-dns.png) 
...
![Changing the timestamp](/05-ctf-writeup/HTB-Unit-42/Images/timestamp-change-pdf-file.png)
...
![searching once.cmd](/05-ctf-writeup/HTB-Unit-42/Images/once.md.png)
...
![malicious domain request](/05-ctf-writeup/HTB-Unit-42/Images/eventid-dns.png)
...
![destination ip](/05-ctf-writeup/HTB-Unit-42/Images/ip-destination.png)
...
![Filtre to detect Cloud drive](/05-ctf-writeup/HTB-Unit-42/Images/filter-eventid-5.png)
